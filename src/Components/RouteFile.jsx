...
const RouteFile = () => {
  var list=[
    ...
    {id:2,name:'Shravani',age:28,course:"MERN",batch:"october"},
    {id:3,name:'Ananya',age:27,course:"MERN",batch:"November"},
    {id:4,name:'Radhika',age:25,course:"MERN",batch:"December"},
];
